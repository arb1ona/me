  ...
  return (
    <div className="profile">
      ...
      <div className="profile__content">
        <div className="profile__title">Arbiona Shahu</div>
        {/* <div className="profile__stack">
                Full Stack Developer
                </div> */}
        <TypedText
          dataText={["Full Stack Developer", "Architect", "Graphic Designer"]}
        />
      ...
      <div className="profile__contact">
        <a
          href="https://drive.google.com/file/d/1SjPX5YCM5-gQzLzuvkBIrpdlylxNGl-A/view?usp=sharing"
          target="_blank"
          rel="noreferrer"
        >
